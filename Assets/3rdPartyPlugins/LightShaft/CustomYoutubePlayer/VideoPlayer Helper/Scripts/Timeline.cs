...
namespace Unity.VideoHelper
{
    ...
    public class Timeline : Selectable, IDragHandler, ICanvasElement, IInitializePotentialDragHandler
    {
        ...
        private float GetPreviewPoint()
        {
            ...
            Vector2 screenMousePosition = Camera.main.ScreenToViewportPoint(Input.mousePosition);
            return screenMousePosition.x;
            ...
            //Debug.LogError(" ==> "+Mathf.Clamp01((localMousePosition[0]) / tooltipContainerRect.rect.size[0]));
